...
- [ ] **Tests** — runner configured; new/changed behavior has a test (written
      first in the spec lane); the whole suite passes.
- [ ] **Lint / Typecheck / Format** pass.
- [ ] **Security** — no secrets or PII committed or logged; authorization is
      deny-by-default (`docs/process/security.md`).
